...
function generateDisplayDiv(educationCount) {
  ...
  '<span class="content-text" id="displayDegreeFrom' + educationCount + '">2020</span> - ' +
  '<span id="displayDegreeTo' + educationCount + '" class="content-text">2023</span>' +
...
function deleteProject(projectCount) {
  ...
  for (var i = 0; i < projectHeaders.length; i++) {
    projectHeaders[i].getElementsByTagName('b')[0].innerText = 'Project ' + (i + 2);
...
function addNewExperience() {
  ...
  content.innerHTML = '<form id="' + formId + '">' +
      '<div class="form-group">' +
      '<input type="text" id="jobtitleInputId' + experienceCount + '" class="form-control" placeholder="Designation" name="' + jobtitleInputId + '" style="height: 30px;" oninput="updateExperience2(' + experienceCount + ')">' +
      '</div>' +
      '<div class="form-group">' +
...
'<div id="exp' + experienceCount + '">' +
    '<h6 class="last-heading" id="Display_Designation' + experienceCount + '">Job Title</h6>' +
    '<p class="content-text" style="margin-bottom: 0px;" id="Display_Cname' + experienceCount + '">Company Name</p>' +
    '<span class="content-text" id="Display_From' + experienceCount + '">From Date</span> | <span class="content-text " id="Display_To' + experienceCount + '">To Date</span>' +
    '<p class="content-text" style="font-size:12px;" id="Display_Description' + experienceCount + '">Description of experience</p>' +
'</div>';
...
var jobtitleValue2 = document.getElementById('jobtitleInputId' + experienceCount).value;
